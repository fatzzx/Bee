...
void recebeNomeVersaoFinal(int numDeJogadores, char jogadores[numDeJogadores][60], char *s){
...
void asterisco(int num_jogadores, char jogadores[num_jogadores][60]) {
  int total = 0;
...
void asterisco2(int num_jogadores, char jogadores[num_jogadores][60]) {
  printf("**");
  int total = 0;
  for (int i = 0; i < num_jogadores; i++) {
    total += strlen(jogadores[i]);
...
void cabecalho(int num_jogadores, char jogadores[num_jogadores][60]){
...
void imprimir_jogo_da_velha(int numDeJogadores, char *jogo_da_velha, char jogadores[numDeJogadores][60], int linhas, int colunas) {
    limpaTerminal();
...
void marcaJogoDaVelhaGravidadeAoContrario(int numDeJogadores, int linhas, int coluna, int linha, char *jogoDaVelha, int colunas, char s, char jogadores[numDeJogadores][60]) {
    perguntaColunaELinha(&coluna, &linha);
...
void marcaJogoDaVelhaGravidade(int numDeJogadores, int linhas, int coluna, int linha, char *jogoDaVelha, int colunas, char s, char jogadores[numDeJogadores][60]) {
    perguntaColunaELinha(&coluna, &linha);
...
int verificaVencedor(int num_jogadores, char jogadores[num_jogadores][60], char *jogo_da_velha, int linhas, int colunas, char simbolo, int condicaoDeVitoria) {
    // Verifica as linhas
    for (int i = 0; i < linhas; i++) {
...
void parabens(int numDeJogadores, char jogadores[numDeJogadores][60]){
  printf(" /^ ^\\\n");
  printf("/ 0 0 \\\n");
